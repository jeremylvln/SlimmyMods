...
public abstract class ALootTableProvider extends LootTableProvider {
    ...
    public ALootTableProvider(DataGenerator dataGeneratorIn) {
    ...
    public String getName() {
        return "ComputerThings LootTables";
    }
}
